...
const OpinionSchema = new Schema({
    ...
    phone: {
        ...
        sparse: true,
        validate: {
            validator: (val) => val == null || /^01[2-9]\d{8}$/.test(val),
    ...
    features: {
        type: [String],
        default: [],
        validate: { validator: (arr) => Array.isArray(arr), message: "Features must be an array of strings" },
    },
...
// };
exports.MOpinion = model("Opinion", OpinionSchema);
